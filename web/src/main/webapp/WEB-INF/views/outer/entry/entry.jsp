...
<div id="mainBox">
    ...
    <form action="${website}entry/entryUpd" method="post" enctype="multipart/form-data">
        <input type="submit" class="flowLeft" value="修改报名信息">
    </form>
    <form action="${website}entry/addFreshman" method="post" enctype="multipart/form-data" id="mianForm">
        <%--id为${myId}--%>
        ${error}
        <table>
            <tr>
            ...
            <tr>
                ...
                <td>ID</td>
                <td colspan="2">
                    <input type="text" readonly placeholder="第一次报名后，将分配ID，请牢记" class="fullinput">
                </td>
            </tr>
            <tr>
                <td>第一志愿</td>
