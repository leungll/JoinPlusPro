...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" type="text/css" href="../../css/outer/entry/entryUpd.css">
...
<body>
<form action="${website}entry/update" method="post" enctype="multipart/form-data">
    <%--id为${myId}--%>
    <table>
        <tr>
        ...
        <tr>
            ...
            <td>ID</td>
            <td colspan="2">
                <input type="text" class="fullinput" name="id">
            </td>
        </tr>
        <tr>
            <td>第一志愿</td>
